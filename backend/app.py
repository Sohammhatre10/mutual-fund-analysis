...
async def search_stock(user_name: str, query: str):
    ...
    if ticker:
        ...
        if mongo_data:
            ...
            return {"ticker": ticker, "mongo_data": mongo_data, "yfinance_data": yfinance_data}
        else:
            ...
            messages_collection.insert_one(interaction_record)
            return {"ticker": ticker, "message": f"No data found for {ticker} in MongoDB."}
    else:
        ...
        messages_collection.insert_one(interaction_record)
        return {"message": "No stock ticker found in the query."}
